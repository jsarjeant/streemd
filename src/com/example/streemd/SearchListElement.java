...
import android.widget.TextView;
   ...
   public class SearchListElement extends LinearLayout implements PostView{
   
      private Post m_Post;
   
      private TextView m_vwTitle;
      private TextView m_vwDescription;
      protected LinearLayout m_vwVideoInfo;
      ...
      public SearchListElement(Context context, Post post) { 
         super(context);
         ...
         this.m_vwVideoInfo = (LinearLayout) findViewById(R.id.videoInfo);
         this.m_Post = post;
